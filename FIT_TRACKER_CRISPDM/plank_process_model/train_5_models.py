...
def load_and_preprocess_data(filepath):
    """Carga, codifica y divide los datos."""
    ...
    print(f"Distribución de clases (entrenamiento):", pd.Series(y_train).value_counts().to_dict())
...
def main():
    ...
    print(f"\nComparación de Modelos para '{EXERCISE_NAME}' completada.")
